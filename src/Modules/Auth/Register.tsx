...
try {
  ...
  style={{
    ...
    > 
     <img  
      src={PMSIcon} alt="PMSIcon" className="w-1 h-1" />
    <div className="d-flex Register-container g-3 flex-column align-items-center justify-content-center">
            ...
            <div
              className=" w-100 px-3 py-3  main-container  border-0 shadow-lg"
            ...
            >
                ...
                <div className="text-lg-start mt-3 mx-5">
                  ...
                  <h2 className="fw-bold d-flex flex-column " style={{ color: "#ffa726", fontSize: "36px" }}>
                   <span className="text-white fw-light  "   style={{
  fontSize: "13px",
  }}>welcome to PMS</span>
                    Create New Account
                  </h2>
  ...
  <label htmlFor="profileImageInput" style={{ cursor: "pointer" }}>
    ...
    >
      {watch("profileImage") && watch("profileImage")?.[0] ? (
        ...
        <FontAwesomeIcon icon={faUser} size="2x" style={{ color: "#ffa726" }} />
      )}
    </div>
  </label>
  <input
                  ...
                  <div className="w-100 d-flex justify-content-center align-items-center m-3">
                    <button
                      ...
                      onMouseOver={(e) => {
                        ...
                        e.currentTarget.style.boxShadow = "0 8px 25px rgba(255, 167, 38, 0.3)"
                      }}
                      onMouseOut={(e) => {
