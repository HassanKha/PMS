...
function ForgetPassword() {
  ...
  useEffect(() => {
    if (userEmail) {
      setValue('email', userEmail); // مباشرة كـ string
    }
  }, [userEmail, setValue]);
        ...
        <div className="ForgetPassword" >
          <div className="container-fluid overlay">
            <div className="row vh-100 justify-content-center align-items-center">
              <div className="col-md-6  rounded-3 py-5 px-5">
                <div>
                  {/* /logoimg/ */}
                  ...
                  <div className="form_forget">
                    ...
                    <form onSubmit={handleSubmit(handelForgetPassword)} >
                      ...
                      <button type="submit" className=' btn_forget w-100 '>{btnloading ? <i className='fa fa-spinner fa-spin'></i> : "Verify"} </button>
                    </form>
                  </div>
                </div>
              </div>
        ...
        <div className="ForgetPassword">
          <div className="container-fluid overlay" >
            <div className="row justify-content-center vh-100  ">
              <div className="col-md-6  rounded-3 px-5">
                <div>
                  {/* /logoimg/ */}
                  <div className="log_img_forget text-center ">
                  ...
                  <div className="form_rest">
                    ...
                    <form onSubmit={handleSubmit(updatePassword)} >
                      ...
                      <button type="submit" className=' btn_resetPass w-100 '>{btnloading ? <i className='fa fa-spinner fa-spin'></i> : "Verify"} </button>
                    </form>
                  </div>
                </div>
              </div>
